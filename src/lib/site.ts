export const site = {
  ...
  author: {
     ...
     */
    bio: "Web系自社開発企業のデータエンジニア。2022〜2024年にAWS認定12種すべてを取得（全冠）、以降は更新していないため順次失効中。IPAデータベーススペシャリスト（2023年）、応用情報技術者、基本情報技術者を保有（IPA試験に有効期限は無い）。AIエージェント自作・AIプロダクト開発の実務経験もあり。個別指導でSQL・データベース・クラウド・AI活用を教えている。",
