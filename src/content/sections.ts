...
export const sections: Record<SectionKey, Section> = {
  ...
  fe: {
    ...
    path: "/fe",
    description:
      "基本情報技術者試験 (FE) の出題範囲を、読むだけでなくブラウザ上で動かして対策できるツール群。科目B の擬似言語は一行ずつ実行して変数の変化を追え、Python / TypeScript に変換して読み比べられる。",
    ogImageAlt: "基本情報技術者試験 対策ツール",
    metaTitle: "基本情報技術者試験の対策ツール｜動かして覚える",
    metaDescription:
      "基本情報技術者試験 (FE) を「読む」ではなく「動かす」で対策するツール集。科目B の擬似言語をブラウザで 1 行ずつ実行して変数の変化を追え、構文別レッスンとオリジナル練習問題で出力を当てる練習ができる。すべて無料・登録不要。",
  },
};
