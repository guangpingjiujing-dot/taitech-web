...
const PAGE_DESCRIPTION =
  "Excel をバックエンドにしたある会社の受注シートに仕込まれた 7 つのおかしな箇所を題材に、原子性・同時実行制御・一意性・参照整合性・永続性など RDB が黙って守ってくれている 5 つの根本価値を体系的に理解する図解シリーズ。";
...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: PAGE_TITLE,
    description:
      "Excel の受注シートに仕込まれた 7 つのおかしな箇所から RDB の根本価値を体系的に理解する。",
...
const faq = [
  {
    ...
    a: "Excel でバックエンドを組んだシートに仕込まれた 7 つのおかしな箇所を通じて、RDB が黙って守ってくれている 5 つの根本価値 (原子性 / 同時実行制御 / 一意性 / 参照整合性 / 永続性) を体感するシリーズです。",
  },
  {
    q: "RDB とは何ですか？",
  ...
  },
  {
    ...
    a: "個人の一時的な作業や少人数の限定的な運用なら問題ありません。ただし複数人が同時更新する業務データや、消えては困る取引記録には向きません。本シリーズの 5 記事 + 総括でその理由を具体的に扱います。",
  },
  {
