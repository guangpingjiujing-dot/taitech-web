...
const FAQ_ITEMS = [
  /*
   * **先頭 2 問は「悩みの質問」**。検索・AI への質問で実際に打たれるのは
   * 制度の質問より先に「未経験でも受かるのか」「何から手を付けるか」なので、
   * それに正面から答える文を最初に置く (AEO / LLMO で引用されるのはこの形)。
   */
  {
    q: "プログラミング未経験でも基本情報技術者試験に合格できますか？",
    a: "できます。科目 B で使う擬似言語は特定のプログラミング言語ではなく、試験のためだけに定義された表記です。実務経験の有無より、変数・条件分岐・繰返し・配列という 4 つの動きを、頭の中で追えるようになっているかどうかで差がつきます。ここのシミュレーターは、その 4 つを一行ずつ動かして目で確かめるためのものです。",
  },
  {
    q: "何から手を付けるとわかりやすいですか？",
    a: "科目 B が不安なら擬似言語の構文別レッスンを変数から順に、科目 A のデータベースが不安なら SQL レッスンを SELECT から順に読むのが近道です。どちらも各節に実行できるエディタが埋め込まれているので、読んだ直後に値を書き換えて結果の変化を見てください。読むだけより圧倒的に速く定着します。",
  },
  {
    q: "このページのツールは無料ですか？",
            ...
            <header className="mb-10 max-w-3xl">
              ...
              >
                <p>
                  ...
                  プログラミング未経験の方でも、擬似言語と SQL
                  が何をしているのかをわかりやすく追えるようにしています。
                </p>
