...
/* セクション (`sections.fe.ogImageAlt`) はハブの名前になったので、
   ツールページは自分の名前を持つ (docs/wip/20260815-fe-sql/00-overview.md §5) */
export const alt = "基本情報技術者試験 擬似言語 実行シミュレーター";
