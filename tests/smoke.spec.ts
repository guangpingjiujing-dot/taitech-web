...
const PAGES = [
  ...
  "/query-plan",
  "/query-plan/what-is",
  "/query-plan/read-tree",
  "/query-plan/explain-basics",
  "/query-plan/explain-analyze",
  "/query-plan/find-bottleneck",
  "/query-plan/scan-nodes",
  "/query-plan/index-cond-vs-filter",
  "/query-plan/join-nodes",
  "/query-plan/sort-and-memory",
